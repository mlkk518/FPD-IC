...
## mlkk added
def conv_2d_layers(in_ch, out_ch, kernel, padding):
    return nn.Sequential(nn.Conv2d(in_ch, in_ch//2, kernel_size=kernel, padding=padding),
                         nn.LeakyReLU(0.1, True),
                         nn.Conv2d(in_ch//2, out_ch, kernel_size=kernel, padding=padding),)
