...
class InferenceLoop:
    ...
    def load_cldm(self) -> None:
        ...
        sd_pretrained = "./weights/v2-1_512-ema-pruned.ckpt"
        sd_weight = torch.load(sd_pretrained, map_location="cpu")
        ...
        cldm_pretrained = "./experiment/PreTrained/0020000.pt"
        cpkt = torch.load(cldm_pretrained, map_location="cpu")
        print(f"Loading CLDM weights from {cldm_pretrained} ! \n")

        self.cldm.load_controlnet_from_ckpt(cpkt)
